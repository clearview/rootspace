...
// Task Board
router.get('/tasks/board/:id', mapRoute(TaskBoardCtrl, 'view'))
router.get('/tasks/board/:id/archived', mapRoute(TaskBoardCtrl, 'viewArchivedTasks'))
router.get('/tasks/board/task/:id', mapRoute(TaskBoardCtrl, 'viewByTaskId'))
router.post('/tasks/board', mapRoute(TaskBoardCtrl, 'create'))
router.post('/tasks/board/:id/search', mapRoute(TaskBoardCtrl, 'searchTasks'))
router.patch('/tasks/board/:id', mapRoute(TaskBoardCtrl, 'update'))
router.delete('/tasks/board/:id', mapRoute(TaskBoardCtrl, 'delete'))
